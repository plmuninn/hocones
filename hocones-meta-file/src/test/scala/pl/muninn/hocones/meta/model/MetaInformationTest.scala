package pl.muninn.hocones.meta.model
...
class MetaInformationTest extends FlatSpec with Matchers {
  ...
  "MetaInformation.findByPath" should "return proper values using path" in {
    testStructure.findByPath("pl.muninn.hocones.meta.model").size shouldBe 5
    testStructure.findByPath("pl.muninn.hocones.meta.test").size shouldBe 5
    testStructure.findByPath("pl.muninn.test.model").size shouldBe 5
  }

  "MetaInformation.findByPathAndName" should "return proper values using path and name" in {
    testStructure.findByPathAndName("pl.muninn.hocones.meta.model", "meta-string").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.model", "meta-number").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.model", "meta-boolean").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.model", "meta-list").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.model", "meta-object").isDefined shouldBe true

    testStructure.findByPathAndName("pl.muninn.hocones.meta.test", "meta-string").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.test", "meta-number").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.test", "meta-boolean").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.test", "meta-list").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.hocones.meta.test", "meta-object").isDefined shouldBe true

    testStructure.findByPathAndName("pl.muninn.test.model", "meta-string").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.test.model", "meta-number").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.test.model", "meta-boolean").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.test.model", "meta-list").isDefined shouldBe true
    testStructure.findByPathAndName("pl.muninn.test.model", "meta-object").isDefined shouldBe true
  }
